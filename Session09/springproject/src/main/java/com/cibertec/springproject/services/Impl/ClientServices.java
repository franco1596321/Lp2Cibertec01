...
import com.cibertec.springproject.client.ReniecClient;
...
@Service
public class ClientServices  implements IClientServices { //Responsable de comunicarse con los repositorios, servicios externos para que se prepare logica
                                                            //con quien habla ,comunicar o grabar
    ...
    public ClientServices(
            ...
            ReniecClient reniecClient   //inyeccion como las demas clases
    ) {
        this._clientRepository = clientRepository;
        this._petRepository = petRepository;
        this._reniecClient=reniecClient;  //inyeccion como las demas clases
    }
    ...
    public PersonaModel GetClientByDNI(String dni) {
        return _reniecClient.getPersonByDni(dni);//GETPERSONBYDNI, llamando al servicio externo mediante el clientservices
    }
}
